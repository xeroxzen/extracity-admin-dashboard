...
const headCells = [
  ...
  { id: "prices", numeric: false, disablePadding: true, label: "TIMES" },
      ...
      <TableRow>
        <TableCell padding="checkbox">
          <Checkbox
            ...
            inputProps={{ "aria-label": "select all fares" }}
          />
        </TableCell>
...
export default function FaresTable() {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = fares.map((n) => n.name);
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={fares.length}
            />
            <TableBody>
              {stableSort(fares, getComparator(order, orderBy))
                ...
                .map((fare, index) => {
                  ...
                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, fare.id)}
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="right">
                        {showPrices(fare.prices)}
                      </TableCell>
                      <TableCell align="right">
                        {moment(fare.date.toDate(), "YYYY-MM-DD").format(
                          "LLL"
                        )}
                      </TableCell>
                      <TableCell align="right">
